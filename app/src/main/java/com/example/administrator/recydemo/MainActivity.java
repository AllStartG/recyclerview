package com.example.administrator.recydemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initDogList() {
        dogList.add(new Dog("dog1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq" , R.drawable.dog1));
        dogList.add(new Dog("dog2" , R.drawable.dog2));
        dogList.add(new Dog("dog3" , R.drawable.dog3));
        dogList.add(new Dog("dog4" , R.drawable.dog4));
        dogList.add(new Dog("dog5qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq" , R.drawable.dog5));
